...
Write-Output "Gathering list of AD Groups"
...
Write-Output "Gathering list of all enabled users"
...
#gather all GPOs
Write-Output "Gathering list of all GPOs"
...
#get inactive users
Write-Output "Gathering list of all inactive enabled users"
...
Write-Output "Gathering list of all inactive computers"
...
#get disabled users
Write-Output "Gathering all disabled users"
...
Write-Output "Gathering all disabled computers"
...
Write-Output "Checking directories now"
...
#export group lists
Write-Output "Exporting all AD Groups"
...
Write-Output "Starting export of members in AD Groups"
$groupProcessed = 0
...
Write-Output "Exporting enabled user list"
...
#export gpo reports
Write-Output "Starting GPO report generation"
$gpoCount = $gpos.count
$gpoProcessed = 0
foreach($gpo in $gpos)
{
    ...
    Write-Output "Running report on $gpoName. Saving to $exportPath\GPO Reports\$gpoNameTrim.html"
...
Write-Output "Exporting inactive users"
...
Write-Output "Exporting inactive computers"
...
Write-Output "Exporting disabled users"
...
Write-Output "Exporting disabled computers"
...
Write-Output "Gathering all Domain Controllers"
...
Write-Output "Gathering FSMO roles"
...
Write-Output "Gathering Replication Status for domain"
